package com.zhufk.myrouter_compiler.utils;
...
public class Constants {
    ...
    // 注解处理器中支持的注解类型
    public static final String IROUTER_ANNOTATION_TYPES = "com.zhufk.myrouter_annotation.ARouter";
    public static final String PARAMETER_ANNOTATION_TYPES = "com.zhufk.myrouter_annotation.Parameter";
    // 每个子模块的模块名
    ...
    // 包名前缀封装
    public static final String BASE_PACKAGE = "com.zhufk.myrouter_api";
    // 路由组Group加载接口
    public static final String AROUTE_GROUP = BASE_PACKAGE + ".core.MyRouterLoadGroup";
    // 路由组Group对应的详细Path加载接口
    public static final String AROUTE_PATH = BASE_PACKAGE + ".core.MyRouterLoadPath";
    // 获取参数，加载接口
